...
struct ContentService {
    ...
    func searchHashtag(tag: String, lastId: Int, limit: Int, completion: @escaping (NetworkResult<Any>) -> Void){
        
        let encodingText = tag.stringByAddingPercentEncodingForFormData(plusForSpace: true)!
        let URL = APIConstants.Hashtag + "/" + encodingText + "?lastId=" + "\(lastId)" + "&limit=" + "\(limit)"
